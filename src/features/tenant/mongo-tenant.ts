...
// // 'use strict';
// import { Plugin, Schema, SchemaType } from "mongoose";
...
// interface MongoTenantSchemaTypeOptions extends SchemaTypeOptions {
...
//             this.schema.eachPath((key: string, path: SchemaType) => {
//                 const pathOptions: MongoTenantSchemaTypeOptions =
//                     <MongoTenantSchemaTypeOptions>path.options;
...
//                     // prepare new options
//                     const indexOptions: MongoTenantSchemaTypeOptions = {
//                         unique: true
//                     };
...
//             [this.getAccessorMethod()]: function(tenantId: string) {
//                 if (!me.isEnabled()) {
//                     return this.model(this.modelName);
//                 }

//                 const modelCache = me._modelCache[this.modelName] || (me._modelCache[this.modelName] = {});
...
//      */
//     createTenantAwareModel(BaseModel, tenantId: string) {
//         const
